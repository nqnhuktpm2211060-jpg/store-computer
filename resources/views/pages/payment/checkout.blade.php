                        ...
                        <div class="breadcrumb-contain">
                            ...
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('checkout.title') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                                ...
                                                <div id="billing-form" class="billing-form">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-12 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="{{ __('checkout.full_name') }}" name="full_name" value="{{old('full_name') ?? Auth::user()?->name}}" required>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 col-12 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="{{ __('checkout.phone_number') }}" name="phone_number" value="{{old('phone_number') ?? Auth::user()?->phone}}" required>
                                                        </div>
                                                        <div class="col-md-6 col-12 mb-3">
                                                        ...
                                                        <div class="accordion-item">
                                                                ...
                                                                <div class="accordion-button collapsed" data-bs-toggle="collapse"
                                                                    ...
                                                                    <div class="custom-form-check form-check mb-0">
                                                                        <label class="form-check-label" for="cash"><input
                                                                            ...
                                                                            {{ __('checkout.cash_on_delivery') }}</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div id="flush-collapseFour" class="accordion-collapse collapse show"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <p class="cod-review">
                                                                        {{ __('checkout.check_before_receive') }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="right-side-summery-box">
                                <div class="summery-box-2">
                                    ...
                                    <ul class="summery-total">
                                        ...
                                        <li>
                                            <h4>{{ __('checkout.coupon_code') }}</h4>
                                            <h4 class="price">0 đ</h4>
                                        </li>
                                
                                        <li class="list-total">
                                            <h4>{{ __('checkout.total') }} (VND)</h4>
                                            <h4 class="price">{{ number_format($total) }} đ</h4>
                                        </li>
                                    </ul>
                                
                                    <button type="submit" class="btn theme-bg-color text-white btn-md w-100 mt-4 fw-bold">{{ __('checkout.place_order') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
